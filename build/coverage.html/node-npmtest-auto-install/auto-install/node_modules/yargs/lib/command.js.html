...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auto-install/auto-install/node_modules/yargs/lib/command.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auto-install/auto-install/node_modules/yargs/lib/command.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">16.78% <small>(24 / 143)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auto-install/auto-install/node_modules/yargs/lib/</a> &#187; command.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var parsedCommand = parseCommand(cmd)</span>
...
<span class="cstat-no" title="statement not covered" >      alias = parseCommand(alias).cmd </span>// remove positional args
...
<span class="cstat-no" title="statement not covered" >      usage.command(cmd, description, aliases)</span>
    }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function parseCommand (cmd) {</span>
<span class="cstat-no" title="statement not covered" >    var extraSpacesStrippedCommand = cmd.replace(/\s{2,}/g, ' ')</span>
<span class="cstat-no" title="statement not covered" >    var splitCommand = extraSpacesStrippedCommand.split(/\s/)</span>
<span class="cstat-no" title="statement not covered" >    var bregex = /\.*[\][&lt;&gt;]/g</span>
<span class="cstat-no" title="statement not covered" >    var parsedCommand = {</span>
      cmd: (splitCommand.shift()).replace(bregex, ''),
      demanded: [],
      optional: []
    }
<span class="cstat-no" title="statement not covered" >    splitCommand.forEach(<span class="fstat-no" title="function not covered" >function (cmd, i) {</span></span>
<span class="cstat-no" title="statement not covered" >      var variadic = false</span>
<span class="cstat-no" title="statement not covered" >      if (/\.+[\]&gt;]/.test(cmd) &amp;&amp; i === splitCommand.length - 1) <span class="cstat-no" title="statement not covered" >variadic = true</span></span>
<span class="cstat-no" title="statement not covered" >      if (/^\[/.test(cmd)) {</span>
<span class="cstat-no" title="statement not covered" >        parsedCommand.optional.push({</span>
...
<span class="cstat-no" title="statement not covered" >    return parsedCommand</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    var argv = parsed.argv</span>
<span class="cstat-no" title="statement not covered" >    var commandHandler = handlers[command] || handlers[aliasMap[command]]</span>
<span class="cstat-no" title="statement not covered" >    var innerArgv = argv</span>
...
<span class="cstat-no" title="statement not covered" >    currentContext.commands.push(command)</span>
<span class="cstat-no" title="statement not covered" >    if (typeof commandHandler.builder === 'function') {</span>
      // a function can be provided, which builds
      // up a yargs chain and possibly returns it.
<span class="cstat-no" title="statement not covered" >      innerArgv = commandHandler.builder(yargs.reset(parsed.aliases))</span>
...
<span class="cstat-no" title="statement not covered" >        innerArgv = innerArgv ? innerArgv.argv : yargs.argv</span>
      } else {
...
<span class="cstat-no" title="statement not covered" >      innerArgv = yargs.reset(parsed.aliases)</span>
<span class="cstat-no" title="statement not covered" >      innerArgv.usage('$0 ' + (parentCommands.length ? parentCommands.join(' ') + ' ' : '') + commandHandler.original)</span>
...
<span class="cstat-no" title="statement not covered" >        innerArgv.option(key, commandHandler.builder[key])</span>
      })
<span class="cstat-no" title="statement not covered" >      innerArgv = innerArgv.argv</span>
    }
<span class="cstat-no" title="statement not covered" >    if (!yargs._hasOutput()) <span class="cstat-no" title="statement not covered" >populatePositional(commandHandler, innerArgv, currentContext, yargs)</span></span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    currentContext.commands.pop()</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function populatePositional (commandHandler, argv, context, yargs) {</span>
...
<span class="cstat-no" title="statement not covered" >      if (demand.variadic) <span class="cstat-no" title="statement not covered" >argv[demand.cmd] = []</span></span>
<span class="cstat-no" title="statement not covered" >      if (!argv._.length) <span class="cstat-no" title="statement not covered" >break</span></span>
<span class="cstat-no" title="statement not covered" >      if (demand.variadic) <span class="cstat-no" title="statement not covered" >argv[demand.cmd] = argv._.splice(0)</span></span>
      else <span class="cstat-no" title="statement not covered" >argv[demand.cmd] = argv._.shift()</span>
<span class="cstat-no" title="statement not covered" >      postProcessPositional(yargs, argv, demand.cmd)</span>
<span class="cstat-no" title="statement not covered" >      addCamelCaseExpansions(argv, demand.cmd)</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (maybe.variadic) <span class="cstat-no" title="statement not covered" >argv[maybe.cmd] = []</span></span>
<span class="cstat-no" title="statement not covered" >      if (!argv._.length) <span class="cstat-no" title="statement not covered" >break</span></span>
<span class="cstat-no" title="statement not covered" >      if (maybe.variadic) <span class="cstat-no" title="statement not covered" >argv[maybe.cmd] = argv._.splice(0)</span></span>
      else <span class="cstat-no" title="statement not covered" >argv[maybe.cmd] = argv._.shift()</span>
<span class="cstat-no" title="statement not covered" >      postProcessPositional(yargs, argv, maybe.cmd)</span>
<span class="cstat-no" title="statement not covered" >      addCamelCaseExpansions(argv, maybe.cmd)</span>
    }
&nbsp;
